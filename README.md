...
[0 vim 必知会 ](#0 vim 必知会)
........[0.1 .vimrc 文件 ](#0.1 .vimrc 文件 )
........[0.2 .vim/ 目录 ](#0.2 .vim/ 目录 )
[1 源码安装编辑器 vim ](#)
[2 插件管理 ](#)
[3 界面美化 ](#)
........[3.1 主题风格 ](#)
...
们重点介绍 clang 子项目，clang 把标准 C/C++ 代码转换为中间语言，换言之，前端 clang + 后端 LLVM（后简称 LLVM/clang）就是一款可替代 GCC 的优秀编译器。相较 GCC，LLVM/clang 有众多优势，尤其以下几点：
...
<h3 name="0">8.4 markdown 即时预览</h3>
